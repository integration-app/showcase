        ...
        >
          <div className="shrink-0">
            <Avatar size='lg' variant='square'>
              ...
              <AvatarFallback size='lg' variant='square'>{integration.name[0]}</AvatarFallback>
            </Avatar>
          </div>
          ...
          <Button variant={integration.connection ? 'destructive' : 'default'}
            onClick={() =>
              integration.connection
                ? handleDisconnect(integration)
                : handleConnect(integration)
            }
          >{integration.connection ? "Disconnect" : "Connect"}</Button>
        </li>
      ))}
    </ul>
  )
